...
export type packageType = "dependencies" | "devDependencies" | "scripts";
...
function removeOriginalFiles() {
    return (tree: Tree) => {
        [
            ...
            `${projectWorkspace.sourceRoot}/app/app.component.less`,
...
function readJson(tree: Tree, file: string, type?: string): any {
    ...
    try {
        ...
        console.log(`Failed when paring file ${file}.`);
        throw error;
    }
}
